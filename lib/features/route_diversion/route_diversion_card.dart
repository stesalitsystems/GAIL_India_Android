...
class RouteDiversionCard extends StatelessWidget {
  const RouteDiversionCard({super.key, required this.item});
  final RouteDiversionItem item;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _row(context, 'Detected At:', item.detectedAt),
            _row(context, 'Resolved At:', item.resolvedAt),
          ],
        ),
      ),
    );
