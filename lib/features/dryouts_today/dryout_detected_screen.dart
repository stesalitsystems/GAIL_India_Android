...
import 'package:gail_india/features/dryouts_today/dryout_detected_card.dart';
import 'package:gail_india/features/dryouts_today/dryout_detected_model.dart';
...
class DryOutsToday extends StatefulWidget {
  const DryOutsToday({super.key});

  @override
  State<DryOutsToday> createState() => _DryOutsTodayState();
}

enum _Panel { none, filter, download }

class _DryOutsTodayState extends State<DryOutsToday> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const GAppBar(title: 'Dry-Outs Today'),
            ...
            Expanded(
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return DryOutsTodayCard(item: _items[index]);
                },
              ),
            ),
          ],
...
final List<DryOutsTodayItems> _items = [
  DryOutsTodayItems(
    gaName: 'Delhi NSR',
    ...
    currentStock: 188.8,
    tripStatus: 'Started',
    nextArrivalAt: '2024-10-01 10:00',
