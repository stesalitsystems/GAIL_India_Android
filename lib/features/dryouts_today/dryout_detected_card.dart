...
class DryOutsTodayCard extends StatelessWidget {
  const DryOutsTodayCard({super.key, required this.item});
  final DryOutsTodayItems item;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _row(context, 'Next Scheduled Arrival Time:', item.nextArrivalAt),
