...
class NoDryOutDetectedDbs extends StatefulWidget {
  const NoDryOutDetectedDbs({super.key});

  @override
  State<NoDryOutDetectedDbs> createState() => _NoDryOutDetectedDbsState();
}

enum _Panel { none, filter, download }

class _NoDryOutDetectedDbsState extends State<NoDryOutDetectedDbs> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const GAppBar(title: 'No Dry-Out Detected DBS'),
            ...
            Expanded(
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return NoDryOutDetectedDbsCard(item: _items[index]);
                },
              ),
            ),
          ],
...
final List<NoRouteDiversionDBSItems> _items = [
  NoRouteDiversionDBSItems(
    gaName: 'Delhi NSR',
