...
class GSidebar extends StatelessWidget {
  ...
  static const _bg = GColors.white;
  static const _fg = GColors.black;
  ...
  // Sidebar capabilities per role
  List<SidebarItem> _itemsFor(UserRole role) {
    switch (role) {
  ...
  (IconData, String) _meta(SidebarItem item) {
    switch (item) {
      ...
      case SidebarItem.lcvTripStatus:
        return (Icons.timeline_outlined, 'LCV Trip Status');
      case SidebarItem.dryOutHistory:
      ...
      case SidebarItem.Reports:
        return (Icons.bar_chart, 'Reports');
      case SidebarItem.map:
        return (Icons.map_outlined, 'Map');
      case SidebarItem.settings:
        return (Icons.settings_outlined, 'Settings');
    }
  }
